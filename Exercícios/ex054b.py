...
print(f'O número de pessoas menores de idade é {menores_idade} e equivale {(menores_idade * 100 / 7):.1f}%.')
print(f'O número de pessoas maiores de idade é {maiores_idade} e equivale {(maiores_idade * 100 / 7):.1f}%.')
